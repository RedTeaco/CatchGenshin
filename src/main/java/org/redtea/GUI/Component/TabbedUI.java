package org.redtea.GUI.Component;
...
public class TabbedUI extends BasicTabbedPaneUI {
    ...
    public TabbedUI(int width, int height) {
        this.height = height;
        this.width = width;
    }
    ...
    public TabbedUI(String bgColorHex,String frontColorHex){
        ...
        selectedColorSet.bottomGradColor2 = Color.decode("#FFFFFF");//选中的最后一层
    ...
    protected void installDefaults(){
        ...
        selectedColor = new Color(250,192,192);
    ...
    protected int calculateTabWidth(int tabPlacement, int tabIndex, FontMetrics fontMetrics) {
        return super.calculateTabWidth(tabPlacement, tabIndex, fontMetrics) + width;
    }
    ...
    @Override
    protected void paintTabArea(Graphics g,int tabPlacement,int selectIndex){
        if (runCount > 1){
            ...
            if (tabPlacement == TOP){
                ...
                for (int i = 0;i<lines.length - 1;i++,fila--) {
                    ...
                    if (i < lines.length - 2) {
                        ...
                        carp.addPoint(tabPane.getWidth() - 2 * fila, lines[i] + rects[selectIndex].height);
                        carp.addPoint(0, lines[i] + rects[selectIndex].height);
                    }
                    carp.addPoint(0, lines[i]);
            ...
            super.paintTabArea(g,tabPlacement,selectIndex);
        }
    ...
    protected int getTabLabelShiftY(int tabPlacement, int tabIndex,
                                    boolean isSelected){return 0;}

    @Override
    protected void paintFocusIndicator(Graphics g,int tabPlacement,
                                       Rectangle[] rect,int tabIndex,Rectangle iconRect,
                                       Rectangle textRect,boolean isSelected){
